...
headerTable.onclick = (e) => {
  ...
  //! Властивість cellIndex повертає позицію клітинки в колекції клітинок рядка таблиці.
  // у таблиці 6 позицій, повертає значення від 0 до 5
  const type = th.dataset.type; // dataset для HTML атрибутів
